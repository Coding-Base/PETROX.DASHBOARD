...
const Dashboard = () => {
  ...
  const [isFormulaBankVisible, setIsFormulaBankVisible] = useState(false);
  ...
  const handleRunCalculation = () => {
    ...
    switch (selectedCalculation) {
      ...
      case "Effective Mud Density (EMD)":
        calculatedResult =
          parsedParams.mudWeight +
          parsedParams.annularPressureLoss / (0.052 * parsedParams.trueVerticalDepth);
        break;
      default:
    ...
    <div className="dashboard">
        ...
        <div className="menu">
          <a href="#home" className="menu-item active">
            <svg style={{ marginRight: "5px" }} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
              <path d="M520-600v-240h320v240H520ZM120-440v-400h320v400H120Zm400 320v-400h320v400H520Zm-400 0v-240h320v240H120Zm80-400h160v-240H200v240Z" />
            </svg>{" "}
            Dashboard
          </a>
          ...
          <a href="#calendar" className="menu-item">
            <svg style={{ marginRight: "5px" }} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
              <path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-840h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T800-240H200Z" />
            </svg>{" "}
            Calendar
          </a>
          <a
      ...
      <div className="main-content">
        ...
        <div className="content">
          ...
          {isFormulaBankVisible && (
            <div className="formula-bank-container" style={{ padding: "20px", border: "1px solid #ccc", borderRadius: "8px", marginTop: "20px" }}>
              <h3 style={{ color: "#302AF3" }}>Formula Bank</h3>
              <div className="formula-section" style={{ marginBottom: "20px" }}>
                <h4 style={{ color: "#302AF3" }}>Physics Formulas</h4>
                <ul>
                  <li>Force = Mass x Acceleration (F = m × a)</li>
                  <li>Energy = Mass x c² (E = m × c²)</li>
                  <li>Ohm’s Law: V = I × R</li>
                  {/* Add more physics formulas as needed */}
                </ul>
              </div>
              <div className="formula-section" style={{ marginBottom: "20px" }}>
                <h4 style={{ color: "#302AF3" }}>Chemistry Formulas</h4>
                <ul>
                  <li>Molarity = Moles of Solute / Liters of Solution</li>
                  <li>Ideal Gas Law: PV = nRT</li>
                  {/* Add more chemistry formulas as needed */}
                </ul>
              </div>
              <div className="formula-section">
                <h4 style={{ color: "#302AF3" }}>Mathematics Formulas</h4>
                <ul>
                  <li>Area of a Circle = πr²</li>
                  <li>Pythagorean Theorem: a² + b² = c²</li>
                  <li>Quadratic Formula: x = (-b ± √(b² - 4ac))/(2a)</li>
                  {/* Add more math formulas as needed */}
                </ul>
              </div>
            </div>
          )}
          ...
          <div className="cal">
            ...
            <svg
              ...
              fill="#302AF3"
            >
              <path d="M160-160v-320h140v320H160Zm250 0v-640h140v640H410Z" />
            </svg>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="48px"
